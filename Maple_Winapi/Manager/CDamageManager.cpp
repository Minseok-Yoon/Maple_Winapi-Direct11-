...
void CDamageManager::CreateDamage(int _iDamage, math::Vector2& _position, bool _bIsCri, int i)
{
    ...
    Vector2 tFirstPos = Vector2(_position.x - (float)pDamage->iLength * 20.f / 2.f,
    ...
    for (int i = 1; i < pDamage->iLength; i++)
    {
        ...
        Vector2 tPos = Vector2(tFirstPos.x + i * 20.f, tFirstPos.y + 8.f - (float)(i % 2));
...
{
    //// NoCri 텍스처 로드
    //m_mapNoCriTexture["0"] = CResourceManager::Load<CTexture>(L"NoCri0", L"texture\\Damage\\NoCri\\0.bmp");
    //if (!m_mapNoCriTexture["0"]) OutputDebugStringA("Failed to load NoCri0 texture\n");
    //m_mapNoCriTexture["1"] = CResourceManager::Load<CTexture>(L"NoCri1", L"texture\\Damage\\NoCri\\1.bmp");
    //if (!m_mapNoCriTexture["1"]) OutputDebugStringA("Failed to load NoCri1 texture\n");
    //m_mapNoCriTexture["2"] = CResourceManager::Load<CTexture>(L"NoCri2", L"texture\\Damage\\NoCri\\2.bmp");
    //if (!m_mapNoCriTexture["2"]) OutputDebugStringA("Failed to load NoCri2 texture\n");
    //m_mapNoCriTexture["3"] = CResourceManager::Load<CTexture>(L"NoCri3", L"texture\\Damage\\NoCri\\3.bmp");
    //if (!m_mapNoCriTexture["3"]) OutputDebugStringA("Failed to load NoCri3 texture\n");
    //m_mapNoCriTexture["4"] = CResourceManager::Load<CTexture>(L"NoCri4", L"texture\\Damage\\NoCri\\4.bmp");
    //if (!m_mapNoCriTexture["4"]) OutputDebugStringA("Failed to load NoCri4 texture\n");
    //m_mapNoCriTexture["5"] = CResourceManager::Load<CTexture>(L"NoCri5", L"texture\\Damage\\NoCri\\5.bmp");
    //if (!m_mapNoCriTexture["5"]) OutputDebugStringA("Failed to load NoCri5 texture\n");
    //m_mapNoCriTexture["6"] = CResourceManager::Load<CTexture>(L"NoCri6", L"texture\\Damage\\NoCri\\6.bmp");
    //if (!m_mapNoCriTexture["6"]) OutputDebugStringA("Failed to load NoCri6 texture\n");
    //m_mapNoCriTexture["7"] = CResourceManager::Load<CTexture>(L"NoCri7", L"texture\\Damage\\NoCri\\7.bmp");
    //if (!m_mapNoCriTexture["7"]) OutputDebugStringA("Failed to load NoCri7 texture\n");
    //m_mapNoCriTexture["8"] = CResourceManager::Load<CTexture>(L"NoCri8", L"texture\\Damage\\NoCri\\8.bmp");
    //if (!m_mapNoCriTexture["8"]) OutputDebugStringA("Failed to load NoCri8 texture\n");
    //m_mapNoCriTexture["9"] = CResourceManager::Load<CTexture>(L"NoCri9", L"texture\\Damage\\NoCri\\9.bmp");
    //if (!m_mapNoCriTexture["9"]) OutputDebugStringA("Failed to load NoCri9 texture\n");

    //// Cri 텍스처 로드
    //m_mapCriTexture["0"] = CResourceManager::Load<CTexture>(L"Cri0", L"texture\\Damage\\Cri\\0.bmp");
    //if (!m_mapNoCriTexture["0"]) OutputDebugStringA("Failed to load Cri0 texture\n");
    //m_mapCriTexture["1"] = CResourceManager::Load<CTexture>(L"Cri1", L"texture\\Damage\\Cri\\1.bmp");
    //if (!m_mapNoCriTexture["1"]) OutputDebugStringA("Failed to load Cri1 texture\n");
    //m_mapCriTexture["2"] = CResourceManager::Load<CTexture>(L"Cri2", L"texture\\Damage\\Cri\\2.bmp");
    //if (!m_mapNoCriTexture["2"]) OutputDebugStringA("Failed to load Cri2 texture\n");
    //m_mapCriTexture["3"] = CResourceManager::Load<CTexture>(L"Cri3", L"texture\\Damage\\Cri\\3.bmp");
    //if (!m_mapNoCriTexture["3"]) OutputDebugStringA("Failed to load Cri3 texture\n");
    //m_mapCriTexture["4"] = CResourceManager::Load<CTexture>(L"Cri4", L"texture\\Damage\\Cri\\4.bmp");
    //if (!m_mapNoCriTexture["4"]) OutputDebugStringA("Failed to load Cri4 texture\n");
    //m_mapCriTexture["5"] = CResourceManager::Load<CTexture>(L"Cri5", L"texture\\Damage\\Cri\\5.bmp");
    //if (!m_mapNoCriTexture["5"]) OutputDebugStringA("Failed to load Cri5 texture\n");
    //m_mapCriTexture["6"] = CResourceManager::Load<CTexture>(L"Cri6", L"texture\\Damage\\Cri\\6.bmp");
    //if (!m_mapNoCriTexture["6"]) OutputDebugStringA("Failed to load Cri6 texture\n");
    //m_mapCriTexture["7"] = CResourceManager::Load<CTexture>(L"Cri7", L"texture\\Damage\\Cri\\7.bmp");
    //if (!m_mapNoCriTexture["7"]) OutputDebugStringA("Failed to load Cri7 texture\n");
    //m_mapCriTexture["8"] = CResourceManager::Load<CTexture>(L"Cri8", L"texture\\Damage\\Cri\\8.bmp");
    //if (!m_mapNoCriTexture["8"]) OutputDebugStringA("Failed to load Cri8 texture\n");
    //m_mapCriTexture["9"] = CResourceManager::Load<CTexture>(L"Cri9", L"texture\\Damage\\Cri\\9.bmp");
